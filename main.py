# python program for accepting 10 students 10 subjects marks find out the total marks ,avg marks
...
class Student:
    ...
    def displayData(self):
        ...
        # print ("Marks in subject 5: ", Student.marks[5])
...
for i in range(1,3):
   ...
   s1 = Student()
   s1.getData(rollno, name, m1, m2, m3, m4, m5)
   s1.displayData()